...
export default {
  data() {
    return {
      ...
      message: '',
      prefix: 'http://localhost:5000/books',
      // prefix: 'http://book-server.apps.pivotal-aws.csv.comcast.com/books',
  ...
  methods: {
    ...
    onSubmitUpdate(evt) {
      ...
      this.updateBook(payload, this.editForm.book_id);
    },
    updateBook(payload, bookID) {
      // const path = `http://localhost:5000/books/${bookID}`;
      const path = this.prefix.concat('/', bookID);
